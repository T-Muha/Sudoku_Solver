...
#supporting functions, and then the graph method. The graph method can only solve a puzzle with at most one level of guessing in#
#this file; guessing during a guess is not possible.                                                                             #
#################################################################################################################################
